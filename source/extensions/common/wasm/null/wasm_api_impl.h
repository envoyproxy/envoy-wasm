...
inline void proxy_sendLocalReply(uint32_t response_code, const char* response_code_details_ptr,
  ...
  sendLocalReplyHandler(current_context_, WS(response_code), WR(response_code_details_ptr),
