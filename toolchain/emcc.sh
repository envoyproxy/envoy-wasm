...
export EMSCRIPTEN_NATIVE_OPTIMIZER='external/com_github_kripken_emscripten_clang/optimizer'
export BINARYEN_ROOT='external/com_github_kripken_emscripten_clang/'
export NODE_JS=''
export EMSCRIPTEN_ROOT='external/com_github_kripken_emscripten_toolchain'
...
python external/com_github_kripken_emscripten_toolchain/em++ "$@"
