...
DEPENDENCY_REPOSITORIES = dict(
    ...
    proxy_wasm_cpp_sdk = dict(
        sha256 = "d81c316d567fa5780862c5a9c879bdb189e94e587e981839806c8ce1d78d1957",
        strip_prefix = "proxy-wasm-cpp-sdk-a23dadb0187780e0b72db5b7a8e1ad2e1f159430",
        urls = ["https://github.com/proxy-wasm/proxy-wasm-cpp-sdk/archive/a23dadb0187780e0b72db5b7a8e1ad2e1f159430.tar.gz"],
        use_category = ["dataplane"],
        cpe = "N/A",
    ),
    proxy_wasm_cpp_host = dict(
        sha256 = "d46be211e76c95986751f5033779bfb8a38e9fa95049ae4cfb5d290c5b331c73",
        strip_prefix = "proxy-wasm-cpp-host-12d2175d5fd58591b3e07cc0d4b10a13d284fe92",
        urls = ["https://github.com/PiotrSikora/proxy-wasm-cpp-host/archive/12d2175d5fd58591b3e07cc0d4b10a13d284fe92.tar.gz"],
        use_category = ["dataplane"],
        cpe = "N/A",
    ),
