...
DEPENDENCY_REPOSITORIES = dict(
    ...
    proxy_wasm_cpp_host = dict(
        sha256 = "f2a5ac1dc3bff59ac119e07a58fbc39f68d50f278b8c3205e4a19139248319ce",
        strip_prefix = "proxy-wasm-cpp-host-fff03bca20cd5335c8f43f098d6da88e90afdde0",
        urls = ["https://github.com/proxy-wasm/proxy-wasm-cpp-host/archive/fff03bca20cd5335c8f43f098d6da88e90afdde0.tar.gz"],
        use_category = ["dataplane"],
        cpe = "N/A",
    ),
