(module
  ...
  (import "env" "_proxy_httpCall" (func $_proxy_httpCall (param i32 i32 i32 i32 i32 i32 i32 i32 i32) (result i32)))
  (import "env" "_proxy_log" (func $_proxy_log (param i32 i32 i32)))
  (import "env" "table" (table $21 47 47 anyfunc))
  ...
  (global $25  (mut i32) (get_global $24))
  (global $26  (mut i32) (i32.const 0))
  (global $27  (mut i32) (i32.const 0))
  (global $28  (mut i32) (i32.const 6720))
  (global $29  (mut i32) (i32.const 5249600))
  (elem $21 (get_global $23)
    $b0 $__ZN14ExampleContext16onRequestHeadersEv $__ZN14ExampleContext17onRequestTrailersEv $__ZN7Context17onResponseHeadersEv $__ZN7Context17onResponseHeadersEv $__ZNKSt11logic_error4whatEv $b0 $b0
    ...
    $b2 $b3 $__ZN7Context7onStartEv $__ZN14ExampleContextD0Ev $__ZN7Context7onStartEv $__ZN7Context7onStartEv $__ZN7Context7onStartEv $__ZN7Context7onStartEv
  ...
  (data $22 (i32.const 3412)
    ...
    "\c0\11\00\00,\11\00\00\af\11\00\00\d0\0e\00\00\00\00\00\00\04\11\00\00F\12\00\00,\11\00\00\a6\12\00\00\00\0f\00\00\00\00\00\00,\11\00\00S\12\00\00\10\0f\00\00\00\00\00\00\04\11\00\00"
    "t\12\00\00,\11\00\00\81\12\00\00\f0\0e\00\00\00\00\00\00,\11\00\00\c8\12\00\00\e8\0e\00\00\00\00\00\00,\11\00\00\d8\12\00\00(\0f")
  (data $22 (i32.const 3916)
  ...
  (data $22 (i32.const 4016)
    "\03")
  (data $22 (i32.const 4055)
    "\ff\ff\ff\ff\ff")
  (data $22 (i32.const 4292)
    ",\13")
  (data $22 (i32.const 4352)
    ...
    "\02\00\00\00\03\00\00\00\02\00\00\00\00\00\00\00(\0f\00\00\0d\00\00\00\0e\00\00\00\05\00\00\00\00\00\00\008\0f\00\00\0d\00\00\00\0f\00\00\00\05\00\00\00cluster\00:met"
    "hod\00:path\00:authority\00foo\00hello world\00trail\00cow\0014ExampleContext\00"
    "7Context\00allocator<T>::allocate(size_t n) 'n' exceeds maximum su"
    "pported size\00-+   0X0x\00(null)\00-0X+0X 0X-0x+0x 0x\00inf\00INF\00nan\00NAN"
    "\00.\00%u\00St9exception\00N10__cxxabiv116__shim_type_infoE\00St9type_info"
    "\00N10__cxxabiv120__si_class_type_infoE\00N10__cxxabiv117__class_typ"
    "e_infoE\00St11logic_error\00St12length_error")
  ...
  (func $__ZN14ExampleContext17onRequestTrailersEv (type $4)
    (param $0 i32)
    (result i32)
    (local $1 i32)
    (local $2 i32)
    ...
    get_local $4
    get_local $7
    call $__Z8httpCallNSt3__217basic_string_viewIcNS_11char_traitsIcEEEERKNS_6vectorINS_4pairINS_12basic_stringIcS2_NS_9allocatorIcEEEES9_EENS7_ISA_EEEES3_SE_j
    drop
    get_local $7
    i32.load
    tee_local $4
  ...
  (func $__Z8httpCallNSt3__217basic_string_viewIcNS_11char_traitsIcEEEERKNS_6vectorINS_4pairINS_12basic_stringIcS2_NS_9allocatorIcEEEES9_EENS7_ISA_EEEES3_SE_j (type $11)
    (param $0 i32)
    (param $1 i32)
    (param $2 i32)
    (param $3 i32)
  ...
  (func $__ZN14ExampleContext18onHttpCallResponseEjNSt3__210unique_ptrI8WasmDataNS0_14default_deleteIS2_EEEES5_S5_ (type $2)
    (param $0 i32)
    (param $1 i32)
    (param $2 i32)
    (param $3 i32)
  ...
  (func $__ZN7Context17onResponseHeadersEv (type $4)
    (param $0 i32)
    (result i32)
    i32.const 0
    )
  ...
  (func $_proxy_onHttpCallResponse (type $12)
    (param $0 i32)
    (param $1 i32)
    (param $2 i32)
    (param $3 i32)
  ...
  (func $__ZN10__cxxabiv18is_equalEPKSt9type_infoS2_b (type $13)
    (param $0 i32)
    (param $1 i32)
    (result i32)
    get_local $0
  ...
  (func $__ZNSt3__215__refstring_imp12_GLOBAL__N_113rep_from_dataEPKc_105 (type $4)
    (param $0 i32)
    (result i32)
    get_local $0
    i32.const -12
