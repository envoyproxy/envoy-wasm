...
The limitation of current apporach is that it doesn't allow any subpackage (sub-directory with `BUILD` in it), so everything should be in top-level BUILD file.
