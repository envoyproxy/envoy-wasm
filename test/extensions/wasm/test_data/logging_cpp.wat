(module
  ...
  (global $16  (mut i32) (i32.const 2880))
  (global $17  (mut i32) (i32.const 5245760))
  (elem $9 (global.get $11)
    $b0)
  (data $10 (i32.const 1024)
    "warn \00test trace\00 logging\00test debug\00test error\00test tick")
