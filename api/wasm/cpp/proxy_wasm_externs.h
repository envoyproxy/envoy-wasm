...
// Network
extern "C" WasmResult proxy_getDownstreamDataBufferBytes(uint32_t start, uint32_t length, const char** ptr, size_t* size);
extern "C" WasmResult proxy_getUpstreamDataBufferBytes(uint32_t start, uint32_t length, const char** ptr, size_t* size);
