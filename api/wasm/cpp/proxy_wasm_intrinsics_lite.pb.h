...
class WKT
    : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:WKT) */ {
public:
  WKT();
  virtual ~WKT();
  ...
  inline WKT* New() const final { return CreateMaybeMessage<WKT>(NULL); }

  WKT* New(::google::protobuf::Arena* arena) const final { return CreateMaybeMessage<WKT>(arena); }
...
inline const ::google::protobuf::Struct& WKT::_internal_struct_() const { return *struct__; }
...
inline void WKT::set_allocated_struct_(::google::protobuf::Struct* struct_) {
  ...
  if (struct_) {
    ...
    if (message_arena != submessage_arena) {
      struct_ =
          ::google::protobuf::internal::GetOwnedMessage(message_arena, struct_, submessage_arena);
    }
